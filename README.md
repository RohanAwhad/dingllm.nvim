...
```
    {
        ...
        config = function()
            ...
            vim.keymap.set({ "n", "v" }, "<leader>ct", together_generate, { desc = "llm together" })
            vim.keymap.set({ "n", "v" }, "<leader>cT", together_help, { desc = "llm together help" })
            vim.keymap.set({ "n", "v" }, "<leader>k", groq_replace, { desc = "llm groq" })
            vim.keymap.set({ "n", "v" }, "<leader>K", groq_help, { desc = "llm groq_help" })
            vim.keymap.set({ "n", "v" }, "<leader>L", openai_help, { desc = "llm openai_help" })
            vim.keymap.set({ "n", "v" }, "<leader>l", openai_generate, { desc = "llm openai" })
